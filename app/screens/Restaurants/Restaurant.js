...
export default function Restaurant(props) {
  ...
  //Validar si el restaurante esta en favoritos
  const [isFavorite, setIsFavorite] = useState(false);
  // Guarda el estado si esta o no logeado el usuario
  ...
  const addFavorite = () => {
    if (!userLogged) {
      toastRef.current.show("Para añadir a favoritos debe iniciar sesión");
    } else {
      const payload = {
